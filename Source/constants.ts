...
export namespace JavaLanguageServerCommands {
	export const EXECUTE_WORKSPACE_COMMAND: string =
		"java.execute.workspaceCommand";

	export const RESOLVE_STACKTRACE_LOCATION: string =
...
export namespace JavaTestRunnerCommands {
	...
	export const RUN_TEST_FROM_JAVA_PROJECT_EXPLORER: string =
		"java.test.runFromJavaProjectExplorer";

	export const DEBUG_TEST_FROM_JAVA_PROJECT_EXPLORER: string =
	...
	export const FIND_TEST_LOCATION: string =
	...
	export const JAVA_TEST_OPEN_STACKTRACE: string =
		"_java.test.openStackTrace";

	export const ASK_CLIENT_FOR_CHOICE: string =
		"_java.test.askClientForChoice";

	export const ASK_CLIENT_FOR_INPUT: string = "_java.test.askClientForInput";

	export const ADVANCED_ASK_CLIENT_FOR_CHOICE: string =
...
export namespace VSCodeCommands {
	...
	export const DEBUG_TESTS_IN_CURRENT_FILE: string =
		"testing.debugCurrentFile";

	export const WORKBENCH_ACTION_QUICK_OPEN: string =
...
export namespace Configurations {
	...
	export const DEFAULT_CONFIG_NAME_SETTING_KEY: string =
	...
	export const HINT_FOR_DEFAULT_CONFIG_SETTING_KEY: string =
		"java.test.message.hintForSettingDefaultConfig";
}
